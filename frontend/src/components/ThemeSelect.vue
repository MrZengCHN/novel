...
const theme = gloableStore();
</script>

<template>
  <div title="切换主题" class="dropdown dropdown-end block ">
    <div tabindex="0" role="button" class="btn group btn-sm gap-1.5 px-1.5 btn-ghost" aria-label="切换主题">
      <div
    ...
    <div tabindex="0"
      ...
      <ul class="menu w-56">
        ...
        <li>
          <button @click="theme.setTheme('light')" class="gap-3 px-2 [&amp;_svg]:visible" data-set-theme="light"
        ...
        <li>
          <button @click="theme.setTheme('dark')" class="gap-3 px-2" data-set-theme="dark"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('cupcake')" class="gap-3 px-2" data-set-theme="cupcake"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('bumblebee')" class="gap-3 px-2" data-set-theme="bumblebee"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('emerald')" class="gap-3 px-2" data-set-theme="emerald"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('corporate')" class="gap-3 px-2" data-set-theme="corporate"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('synthwave')" class="gap-3 px-2" data-set-theme="synthwave"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('retro')" class="gap-3 px-2" data-set-theme="retro"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('cyberpunk')" class="gap-3 px-2" data-set-theme="cyberpunk"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('valentine')" class="gap-3 px-2" data-set-theme="valentine"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('halloween')" class="gap-3 px-2" data-set-theme="halloween"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('garden')" class="gap-3 px-2" data-set-theme="garden"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('forest')" class="gap-3 px-2" data-set-theme="forest"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('aqua')" class="gap-3 px-2" data-set-theme="aqua"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('lofi')" class="gap-3 px-2" data-set-theme="lofi"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('pastel')" class="gap-3 px-2" data-set-theme="pastel"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('fantasy')" class="gap-3 px-2" data-set-theme="fantasy"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('wireframe')" class="gap-3 px-2" data-set-theme="wireframe"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('black')" class="gap-3 px-2" data-set-theme="black"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('luxury')" class="gap-3 px-2" data-set-theme="luxury"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('dracula')" class="gap-3 px-2" data-set-theme="dracula"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('cmyk')" class="gap-3 px-2" data-set-theme="cmyk"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('autumn')" class="gap-3 px-2" data-set-theme="autumn"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('business')" class="gap-3 px-2" data-set-theme="business"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('acid')" class="gap-3 px-2" data-set-theme="acid"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('lemonade')" class="gap-3 px-2" data-set-theme="lemonade"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('night')" class="gap-3 px-2" data-set-theme="night"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('coffee')" class="gap-3 px-2" data-set-theme="coffee"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('winter')" class="gap-3 px-2" data-set-theme="winter"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('dim')" class="gap-3 px-2" data-set-theme="dim"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('nord')" class="gap-3 px-2" data-set-theme="nord"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('sunset')" class="gap-3 px-2" data-set-theme="sunset"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('caramellatte')" class="gap-3 px-2" data-set-theme="caramellatte"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('abyss')" class="gap-3 px-2" data-set-theme="abyss"
            data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button @click="theme.setTheme('silk')" class="gap-3 px-2" data-set-theme="silk"
            data-act-class="[&amp;_svg]:visible">
