...
<template>
    <div class="min-h-screen flex items-center justify-center pt-16">
        <div class="card w-96 bg-base-100 shadow-xl border border-base-200 backdrop-blur-sm bg-opacity-80">
            <div class="card-body">
                <h2 class="card-title justify-center text-2xl font-bold mb-4">注册</h2>
                ...
                <div class="card-actions justify-center mt-8 gap-4 flex-col">
                    <button class="btn btn-primary w-full" @click="handleRegister" :disabled="loading">
                        <span v-if="loading" class="loading loading-spinner"></span>
                        注册
                    </button>
                    <div class="text-sm text-center">
                        已有账号？ <RouterLink to="/login" class="link link-primary">去登录</RouterLink>
                    </div>
                </div>
            </div>
        </div>
